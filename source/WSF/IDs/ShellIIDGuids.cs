namespace WSF.IDs
{
    internal sealed class ShellIIDGuids
    {
        ...
        ////internal const string IID_ExtractIconW = "{000214FA-0000-0000-C000-000000000046}";
        ////internal const string IID_IDataObject = "{0000010E-0000-0000-C000-000000000046}";
        ////internal const string IID_IContextMenu = "000214e4-0000-0000-c000-000000000046";
        internal const string IID_IShellBrowser = "000214E2-0000-0000-C000-000000000046";
        ////internal const string IID_IFolderView = "cde725b0-ccc9-4519-917e-325d72fab4ce";
