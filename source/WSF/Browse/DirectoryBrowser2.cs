namespace WSF.Browse
{
    ...
    /// </summary>
    internal sealed partial class DirectoryBrowser2 : IDirectoryBrowser2
    {
        #region fields
        ...
        /// Class constructor
        /// </summary>
        public DirectoryBrowser2(BrowseItemFromPath2 itemModel)
        {
        ...
        public DirectoryBrowser2(DirectoryBrowser2 copyThis)
        {
            if (copyThis == null)
                return;
        ...
        public object Clone()
        {
            return new DirectoryBrowser2(this);
        }
        ...
        public bool Equals(IDirectoryBrowser2 other)
        {
            if (other == null)
                return false;
        ...
        {
            var otherbrowser = obj as IDirectoryBrowser2;
        ...
        private IKnownFolderProperties LoadKnownFolder()
        {
            if (this.IsSpecialParseItem)
                return Browser2.FindKnownFolderByFileSystemPath(this.SpecialPathId);
            else
            {
