namespace UnitTestWSF.DirectoryBrowser2
{
    ...
    public class ChildItemTests
    {
        ...
        public void GetDesktopChildItems()
        {
            ...
            int iCnt = 0;
            foreach (var item in Browser2.GetChildItems(KF_IID.ID_FOLDERID_Desktop))
            {
        ...
        public void GetPCChildItems()
        {
            ...
            int iCnt = 0;
            foreach (var item in Browser2.GetChildItems(KF_IID.ID_FOLDERID_ComputerFolder))
            {
                Assert.IsTrue(item != null);
                iCnt++;
            }
        ...
        public void GetProgramFilesChildItems()
        {
            ...
            int iCnt = 0;
            foreach (var item in Browser2.GetChildItems(KF_IID.ID_FOLDERID_ProgramFiles))
            {
                Assert.IsTrue(item != null);
                iCnt++;
            }
        ...
        public void GetMusicChildItems()
        {
            ...
            int iCnt = 0;
            foreach (var item in Browser2.GetChildItems(KF_IID.ID_FOLDERID_Music))
            {
                Assert.IsTrue(item != null);
                iCnt++;
            }
        ...
        public void GetOneDriveFolderItem()
        {
            ...
            var items1 = Browser2.GetDirectories(path1);
            var items = Browser2.GetDirectories(path);
